...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    function showErrorModal1(message) {
    ...
    btnLogin.addEventListener("click", async function() {
        const userDatabase = await (0, _getUsers.getUsers)(); // Obtener la base de datos de usuarios
        let userknow = false;
        ...
        if (userknow) window.location.href = "./portal.html";
        else showErrorModal1("Nombre de usuario o contrase\xf1a incorrectos");
    });
...
document.addEventListener("DOMContentLoaded", ()=>{
    ...
    btnLogin.addEventListener("click", async function() {
        ...
        if (userknow) window.location.href = "./portal.html";
        else showErrorModal("User name or password incorrect");
    });
    btnSignUp.addEventListener("click", ()=>{
        window.location.href = "sign_up.html";
    });
...
},{}]},["gHDMI","ebWYT"], "ebWYT", "parcelRequire6682")
