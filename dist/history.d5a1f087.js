...
})({"2o3k7":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "4e35a4ced5a1f087";
"use strict";
...
},{}],"8cPYf":[function(require,module,exports) {
var _getDetallesConsultas = require("../services/getDetallesConsultas");
// Elementos del DOM
...
function filterConsultas(consultas, searchTerm) {
    ...
    return consultas.filter((consulta)=>consulta.incident.toLowerCase().includes(lowerCaseSearchTerm) || consulta.incidentDetails.toLowerCase().includes(lowerCaseSearchTerm));
}
// Función para mostrar el historial de consultas
async function displayHistory(searchTerm = "") {
    try {
        const history = await (0, _getDetallesConsultas.gethistoryConsultas)();
        ...
        alert("No se pudo mostrar el historial. Int\xe9ntalo de nuevo.");
    }
}
...
},{"../services/getDetallesConsultas":"b0tqk"}],"b0tqk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "gethistoryConsultas", ()=>gethistoryConsultas);
async function gethistoryConsultas() {
    try {
        ...
        if (!response.ok) throw new Error("Error fetching detalles consultas");
...
},{}]},["2o3k7","8cPYf"], "8cPYf", "parcelRequire6682")

//# sourceMappingURL=history.d5a1f087.js.map
