...
})({"9qVEQ":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "8bc1122ce97e16f0";
"use strict";
...
},{}],"7PDLc":[function(require,module,exports) {
...
signUp.addEventListener("click", async function() {
    try {
        ...
        const userDatabase = await (0, _getUsers.getUsers)();
        ...
        for(let index = 0; index < userDatabase.length; index++){
            ...
            if (data.email === email.value || data.username === username.value || data.cedula === cedula.value) {
                isDuplicate = true; // Marca que los datos están duplicados
                break; // Sale del bucle si encuentra un duplicado
            }
        }
        if (isDuplicate) // Muestra un mensaje de error si los datos ya existen
        showErrorModal("Datos repetidos. Por favor, use otro email, nombre de usuario o c\xe9dula.");
        else {
            // Si los datos no están duplicados, registra al nuevo usuario
            await (0, _postUsers.postUsers)(email.value, username.value, cedula.value, psw.value);
            // Muestra un mensaje de éxito
            showSuccessModal("Datos creados exitosamente. Ahora puedes iniciar sesi\xf3n.");
        }
    } catch (error) {
        // Captura y muestra un error si ocurre durante el proceso de registro
        console.error("Error al registrar el usuario:", error);
        showErrorModal("Hubo un error al registrar el usuario. Por favor, int\xe9ntalo de nuevo.");
    }
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9qVEQ","7PDLc"], "7PDLc", "parcelRequire6682")

//# sourceMappingURL=sign_up.e97e16f0.js.map
